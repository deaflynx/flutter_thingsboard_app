...
extension EntityTypeTranslationUtils on EntityType {
  String getTranslatedEntityType(BuildContext context) {
    return switch (this) {
      ...
      EntityType.JOB => S.of(context).job,
      EntityType.ADMIN_SETTINGS => S.of(context).adminSettings,
  ...
  String getTranslatedAlarmStatus(BuildContext context) {
    return switch (this) {
      AlarmStatus.ACTIVE_ACK =>
        '${S.of(context).active} ${S.of(context).acknowledged}',
      AlarmStatus.ACTIVE_UNACK =>
        '${S.of(context).active} ${S.of(context).unacknowledged}',
  ...
  String getTranslatedActionType(BuildContext context) {
    return switch (this) {
      ...
      ActionType.ATTRIBUTES_UPDATED =>
        S.of(context).actionTypeAttributesUpdated,
      ActionType.ATTRIBUTES_DELETED =>
        S.of(context).actionTypeAttributesDeleted,
      ActionType.RPC_CALL => S.of(context).actionTypeRpcCall,
      ActionType.CREDENTIALS_UPDATED =>
        S.of(context).actionTypeCredentialsUpdated,
      ActionType.ASSIGNED_TO_CUSTOMER =>
        S.of(context).actionTypeAssignedToCustomer,
      ActionType.UNASSIGNED_FROM_CUSTOMER =>
        S.of(context).actionTypeUnassignedFromCustomer,
      ...
      ActionType.RELATION_ADD_OR_UPDATE =>
        S.of(context).actionTypeRelationAddOrUpdate,
      ...
      ActionType.ASSIGNED_FROM_TENANT =>
        S.of(context).actionTypeAssignedFromTenant,
